...
final class Chunk {
    ...
    static public class ChunkDecoder extends InputStream {
         ...
         * Constructor
         *
         * @param in The source input stream which contains chunk-encoded data
         *           stream.
         */
         ...
         *
         * @throws java.io.IOException when no more data is available.
         */
    ...
    static public class ChunkEncoder extends OutputStream {
         ...
         * @param buf user-supplied buffer. The buffer would be used exclusively by
         ...
         * @param offset Offset to chunk buffer for the beginning of chunk.
         * @param len
         * @param last   Is this the last call to flushBuffer?
         */
         ...
         *
         * @param data   User supplied data buffer.
         * @param offset Offset to user data buffer.
         * @param len    User data buffer size.
         */
    ...
    static public class SingleChunkEncoder extends OutputStream {
         ...
         *
         * @param out  the underlying output stream.
         * @param size The total # of bytes to be written as a single chunk.
