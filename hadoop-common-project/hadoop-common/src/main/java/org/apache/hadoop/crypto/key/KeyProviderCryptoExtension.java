...
public class KeyProviderCryptoExtension extends
    ...
    public interface CryptoExtension extends KeyProviderExtension.Extension {
         ...
         *
         * @param encryptionKeyName The latest KeyVersion of this key's material will be encrypted.
         ...
         * @throws GeneralSecurityException thrown if the key material could not be encrypted because of a
         *                                  cryptographic issue.
         */
         ...
         *
         * @param encryptedKeyVersion contains keyVersionName and IV to decrypt the encrypted key
         *                            material
         ...
         * @throws GeneralSecurityException thrown if the key material could not be decrypted because of a
         *                                  cryptographic issue.
         */
