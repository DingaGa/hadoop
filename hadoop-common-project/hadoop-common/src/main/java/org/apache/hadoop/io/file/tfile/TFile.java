...
public class TFile {
    ...
    public static class Writer implements Closeable {
         ...
         * Constructor
         *
         * @param fsdos        output stream for writing. Must be at position 0.
         * @param minBlockSize Minimum compressed block size in bytes. A compression block will
         *                     not be closed until it reaches this size except for the last
         *                     block.
         * @param compressName Name of the compression algorithm. Must be one of the strings
         *                     returned by {@link TFile#getSupportedCompressionAlgorithms()}.
         * @param comparator   Leave comparator as null or empty string if TFile is not sorted.
         ...
         * stream.
         *
         * @param length The expected length of the key. If length of the key is not
         ...
         * be closed).
         *
         * @param length The expected length of the value. If length of the value is not
         *               known, set length = -1. Otherwise, the application must write
         *               exactly as many bytes as specified here before calling close on
         ...
         * @param compressName Name of the compression algorithm to be used. Must be one of the
         *                     strings returned by
         ...
         * @throws IOException
         * @throws MetaBlockAlreadyExists the Meta Block with the same name already exists.
         */
         ...
         *
         * @param bForceFinish Force the closure regardless of the block size.
         * @throws IOException
         */
    ...
    public static class Reader implements Closeable {
         ...
         * Constructor
         *
         * @param fsdis      FS input stream of the TFile.
         * @param fileLength The length of TFile. This is required because we have no easy
         ...
         * @throws MetaBlockDoesNotExist If the meta block with the name does not exist.
         */
         ...
         *
         * @param offset the user supplied offset.
         ...
         *
         * @param offset The beginning byte offset in the TFile.
         ...
         *
         * @param beginKey Begin key of the scan (inclusive). If null, scan from the first
         *                 key-value entry of the TFile.
         * @param endKey   End key of the scan (exclusive). If null, scan up to the last
         *                 key-value entry of the TFile.
         ...
         *
         * @param beginRecNum The RecordNum for the first record (inclusive).
         * @param endRecNum   The RecordNum for the last record (exclusive). To scan the whole
        ...
        public static class Scanner implements Closeable {
             ...
             * Constructor
             *
             * @param reader   The TFile reader object.
             * @param offBegin Begin byte-offset of the scan.
             * @param offEnd   End byte-offset of the scan.
             * @throws IOException The offsets will be rounded to the beginning of a compressed
             ...
             *
             * @param reader The TFile reader object.
             * @param begin  Begin location of the scan.
             * @param end    End location of the scan.
             * @throws IOException
             */
             ...
             *
             * @param reader   The TFile reader object.
             * @param beginKey Begin key of the scan. If null, scan from the first <K,V>
             *                 entry of the TFile.
             * @param endKey   End key of the scan. If null, scan up to the last <K, V> entry
             *                 of the TFile.
             * @throws IOException
             */
             ...
             *
             * @param key       The input key
             * @param keyOffset offset in the key buffer.
             ...
             *
             * @param l new cursor location. It must fall between the begin and end
             *          location of the scanner.
             * @throws IOException
             */
             ...
             *
             * @param other user-specified key.
            ...
            public class Entry implements Comparable<RawComparable> {
                 ...
                 *
                 * @param key   BytesWritable to hold key.
                 * @param value BytesWritable to hold value
                 * @throws IOException
                 */
                 ...
                 *
                 * @param key BytesWritable to hold the key.
                 * @throws IOException
                 */
                 ...
                 *
                 * @param buf The buffer supplied by user. The length of the buffer must
                 ...
                 * Copy the key into user supplied buffer.
                 *
                 * @param buf    The buffer supplied by user.
                 * @param offset The starting offset of the user buffer where we should copy
             ...
             *
             * @param n Number of key-value pairs to skip in block.
             * @throws IOException
             */
             ...
             * @param greater advance until we find a key greater than the input key.
     ...
     *
     * @param args A list of TFile paths.
     */
