...
public interface HasEnhancedByteBufferAccess {
     ...
     * argument.
     *
     * @param factory   If this is non-null, it will be used to create a fallback
     *                  ByteBuffer when the stream itself cannot create one.
     * @param maxLength The maximum length of buffer to return.  We may return a buffer
     *                  which is shorter than this.
     * @param opts      Options to use when reading.
     * @return We will always return an empty buffer if maxLength was 0,
