...
final class BCFile {
    ...
    static public class Writer implements Closeable {
        ...
        private static interface BlockRegister {
             ...
             *
             * @param raw         The size of block in terms of uncompressed bytes.
             * @param offsetStart The start offset of the block.
             * @param offsetEnd   One byte after the end of the block. Compressed block size is
        ...
        private static final class WBlockState {
            ...
            /**
             * @param compressionAlgo The compression algorithm to be used to for compression.
             * @throws IOException
             */
        ...
        public class BlockAppender extends DataOutputStream {
             ...
             * Constructor
             *
             * @param register the block register, which is called when the block is closed.
         ...
         * @param compressionName Name of the compression algorithm, which will be used for all
         *                        data blocks.
         * @throws IOException
         ...
         *
         * @param name            The name of the Meta Block. The name must not conflict with
         *                        existing Meta Blocks.
         * @param compressionName The name of the compression algorithm to be used.
    ...
    static public class Reader implements Closeable {
         ...
         *
         * @param offset User-specific offset.
