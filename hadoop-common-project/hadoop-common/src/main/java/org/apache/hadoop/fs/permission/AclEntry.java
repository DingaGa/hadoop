...
public class AclEntry {
     ...
     * @param includePermission for setAcl operations this will be true. i.e. AclSpec should
     ...
     *
     * @param aclStr            String representation of an ACL.<br>
     *                          Example: "user:foo:rw-"
     * @param includePermission for setAcl operations this will be true. i.e. Acl should include
     *                          permissions.<br>
